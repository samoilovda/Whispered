...
> Верхний раздел «Статус реализации» является итоговым. Более поздние
> baseline/gap-списки ниже сохранены как история плана и могут описывать уже
> закрытые W1–W9; текущая support matrix находится в `README.md`.
